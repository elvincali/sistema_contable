...
<head>
  ...
  <link rel="stylesheet" href="adminlte/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  <!-- Tempusdominus Bootstrap 4 -->
  <link rel="stylesheet" href="adminlte/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- Select2 -->
  <link rel="stylesheet" href="adminlte/select2/select2.min.css">
  <link rel="stylesheet" href="adminlte/select2-bootstrap4-theme/select2-bootstrap4.min.css">
  <!-- Bootstrap4 Duallistbox -->
  <link rel="stylesheet" href="adminlte/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="adminlte/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="adminlte/dropzone/min/dropzone.min.css">
  <!-- Theme style -->
...
<!-- Bootstrap4 Duallistbox -->
<script src="adminlte/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
<!-- InputMask -->
<script src="adminlte/moment/moment.min.js"></script>
<script src="adminlte/inputmask/jquery.inputmask.min.js"></script>
<!-- date-range-picker -->
<script src="adminlte/daterangepicker/daterangepicker.js"></script>
<!-- bootstrap color picker -->
<script src="adminlte/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="adminlte/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Bootstrap Switch -->
<script src="adminlte/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<!-- BS-Stepper -->
<script src="adminlte/bs-stepper/js/bs-stepper.min.js"></script>
<!-- dropzonejs -->
<script src="adminlte/dropzone/min/dropzone.min.js"></script>
<!-- AdminLTE App -->
