...
<div class="container">
    ...
    <link rel="stylesheet" href="{{ asset('https://unpkg.com/leaflet@1.7.1/dist/leaflet.css') }}"
          integrity="sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A=="
          crossorigin=""/>
    <!-- Esri Leaflet Geocoder -->
    <link
        rel="stylesheet"
        href="{{ asset('https://unpkg.com/esri-leaflet-geocoder/dist/esri-leaflet-geocoder.css') }}"
{{--        href="{{ asset('https://unpkg.com/esri-leaflet-geocoder@3.0.0/dist/esri-leaflet-geocoder.css') }}"--}}
    />
      ...
      <div class="row" id="tabla">
        <div class="col-12">
              ...
              <form action="{{ route('sucursales.update', $sucursal->id) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                <!--Método que permite actualizar datos-->
                @csrf
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                    <div id="centrado">
                      <label for="formbuscador"><h3>Ubicación</h3></label>
                    </div>
...
@section('js')
  {{-- <script src="{{ asset('https://unpkg.com/leaflet@1.7.1/dist/leaflet.js') }}"
          integrity="sha512-XQoYMqMTK8LvdxXYG3nZ448hOEQiglfqkJs1NOQV44cWnUrBc8PkAOcXy20w0vlaXaVUearIOBhiXZ5V3ynxwA=="
          crossorigin=""></script> --}}
  <!-- Load Esri Leaflet from CDN -->
  {{-- <script src="{{ asset('https://unpkg.com/esri-leaflet') }}" defer></script> --}}
{{--  <script src="{{ asset('https://unpkg.com/esri-leaflet@3.0.0/dist/esri-leaflet.js') }}" defer></script>--}}
  <!-- Esri Leaflet Geocoder -->
  {{-- <script src="{{ asset('https://unpkg.com/esri-leaflet-geocoder') }}" defer></script> --}}
{{--  <script src="{{ asset('https://unpkg.com/esri-leaflet-geocoder@3.0.0/dist/esri-leaflet-geocoder.js') }}" defer></script>--}}
